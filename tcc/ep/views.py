...
def knowledge(request):
	...
	match request.path:
		case '/base_conhecimento':
			return render(request, 'knowledge_home.html')
		case '/base_conhecimento/riscos':
			all_risks = Risk.objects.filter(active=1)
			return render(request, 'knowledge_risks.html', {'risks': all_risks})
		case '/base_conhecimento/fmea':
			return render(request, 'knowledge_fmea.html')
